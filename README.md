## Тестове завдання "Колекція твітів"
...
![Simple users data into backend](./assets/user.jpg)

Макет:
[https://www.figma.com/file/zun1oP6NmS2Lmgbcj6e1IG/Test?node-id=0%3A1&t=VoiYTfiXggVItgVd-1](https://www.figma.com/file/zun1oP6NmS2Lmgbcj6e1IG/Test?node-id=0%3A1&t=VoiYTfiXggVItgVd-1)
...
показати твіти, у яких стан **follow**. **followings** - показати твіти, у яких
стан
